    ...
    <PublicShell>
      <article className="mx-auto max-w-3xl px-5 py-16 lg:px-8">
        ...
        <Section title="8. Cookies, Local Storage, and Analytics">
          <p>The public booking experience may use browser local storage to preserve an in-progress booking draft on the device. Necessary cookies may be used for authenticated administrative functions. We use Google Analytics 4 to measure aggregated use of public pages and the booking funnel. We do not send names, email addresses, phone numbers, document information, appointment notes, payment-card information, identity-verification information, or secure appointment-link tokens to Google Analytics.</p>
        </Section>
