  ...
  async function upload() {
    ...
    try {
      ...
      if (response.ok && result?.status === "uploaded" && isCustomerDocument(result.document)) {
        ...
        setMessage(replacementDocumentId ? "Replacement document received. We’re securely processing and reviewing your document. You don’t need to stay on this page. We’ll let you know if anything else is needed." : "Document received. We’re securely processing and reviewing your document. You don’t need to stay on this page. We’ll let you know if anything else is needed.");
        return;
      }
