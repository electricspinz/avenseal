  ...
  async function upload() {
    ...
    try {
      ...
      if (response.ok && result?.status === "uploaded" && isCustomerDocument(result.document)) {
        ...
        setMessage(replacementDocumentId ? "Replacement uploaded." : "Upload complete.");
        return;
      }
