...
Provide the version-controlled entry point for Avenseal's Product Blueprint and Knowledge Base.
...
## Avenseal Knowledge Base

The Knowledge Base extends the existing Product Blueprint with a launch-oriented company handbook. It uses **Current**, **Planned / future**, and **To Be Finalized** labels so documentation never presents unapproved work as live capability.

| Area | Entry point |
| --- | --- |
| Company | [Company Overview](01-company/Company-Overview.md) |
| Brand | [Brand Standards v1](02-brand/Brand-Standards-v1.md) |
| Marketing | [Marketing Strategy](03-marketing/Marketing-Strategy.md) |
| Website | [Website Architecture](04-website/Website-Architecture.md) |
| SEO | [SEO Strategy](05-seo/SEO-Strategy.md) |
| Google Business | [Google Business Profile](06-google-business/Google-Business-Profile.md) |
| Customer experience | [Customer Journey](07-customer-experience/Customer-Journey.md) |
| Operations | [Daily Operations](08-operations/Daily-Operations.md) |
| Technology | [Architecture Overview](09-technology/Architecture-Overview.md) |
| Roadmap | [Product Roadmap](10-roadmap/Product-Roadmap.md) |
| Licensing | [Licensing Overview](11-licensing/Licensing-Overview.md) |
...
| [04 Marketing](04-marketing/positioning.md) | Approved positioning, organic growth, education, referrals, reviews, social, and launch planning | [Positioning](04-marketing/positioning.md) · [SEO Roadmap](04-marketing/seo-roadmap.md) · [Content Roadmap](04-marketing/content-roadmap.md) · [Google Business Profile](04-marketing/google-business-profile.md) · [Review Strategy](04-marketing/review-strategy.md) · [Social Media](04-marketing/social-media-strategy.md) · [Email Strategy](04-marketing/email-strategy.md) · [30-Day Launch Plan](04-marketing/launch-plan.md) |
...
| [05 Sales](05-sales/pricing-and-service-model.md) | Launch service model, pricing, and controlled partner communication | [Pricing and Service Model](05-sales/pricing-and-service-model.md) · [Pricing Strategy](05-sales/pricing-strategy.md) · [Referral Partner Strategy](05-sales/referral-partner-strategy.md) · [Referral Partner Script](05-sales/referral-partner-script.md) |
