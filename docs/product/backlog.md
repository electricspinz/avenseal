...
| COM-003 | Automated appointment reminders | Communications | Reminders need lifecycle scheduling | Better appointment preparation | P0 | Active | Reminder scheduler | Delivery remains in communication worker |
