...
| PR #11 — Provider-agnostic communications engine | Active | Deliver reliable appointment communications | Queue persistence, provider boundary, email-first delivery, retries, tracking | Appointments and secure links | SMS/push and scheduled worker deferred | Unit, integration, queue and failure-path coverage |
