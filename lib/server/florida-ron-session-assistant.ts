...
const module = (id: string, classification: ComplianceClassification): FloridaRonModule => ({ id, version: "1.0", classification });
export const floridaRonModules = {
  core: module("FL-CORE", "required_by_florida_law"), identity: module("FL-IDENTITY", "required_by_florida_law"), location: module("FL-LOCATION", "required_by_florida_law"), outsideFlorida: module("FL-OUTSIDE-FL", "conditional_florida_requirement"), willingness: module("FL-WILLINGNESS", "required_by_florida_law"), ackIndividual: module("FL-ACK-INDIVIDUAL", "conditional_florida_requirement"), ackRepresentative: module("FL-ACK-REPRESENTATIVE", "conditional_florida_requirement"), jurat: module("FL-JURAT", "conditional_florida_requirement"), physicalWitness: module("FL-PHYSICAL-WITNESS", "conditional_florida_requirement"), remoteWitness: module("FL-REMOTE-WITNESS", "conditional_florida_requirement"), special117285: module("FL-117285", "conditional_florida_requirement"), multiPrincipal: module("FL-MULTI-PRINCIPAL", "conditional_florida_requirement"), complete: module("FL-COMPLETE", "required_by_florida_law")
} as const;
