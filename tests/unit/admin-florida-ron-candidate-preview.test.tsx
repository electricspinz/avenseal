...
describe("AdminFloridaRonCandidatePreview", () => {
  ...
  it("labels the Candidate preview, renders module identity/classification, and safely navigates sourced modules", async () => {
    ...
    expect(screen.getByText("Required confirmations")).toBeTruthy();
    ...
    expect(screen.getByText(/Orange County; Affidavit; jurat/)).toBeTruthy();
    ...
    const normalReadAloud = screen.getByText(/Orange County; Affidavit; jurat/);
